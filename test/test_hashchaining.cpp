...
TEST(HashChaining, TestGet) {
    ...
    auto elements = std::array{"AAA", "BBB", "CCC", "DDD", "EEE", "FFF",
                               "GGG", "HHH", "III"};
...
TEST(HashChaining, TestPush) {
    ...
    auto elements = std::array{"BBB", "CCC", "DDD", "EEE", "FFF",
                               "GGG", "HHH", "III"};
    ...
    elements = std::array{"BBB", "CCC", "DDD", "EEE", "FFF",
                          "GGG", "HHH", "III"};
...
TEST(HashChaining, TestChaining) {
    ...
    // Test an inherited class where the resize function is overwritten to do nothing.
    // This essentially forces chaining to occur as we are pushing more elements than
