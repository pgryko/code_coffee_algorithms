...
class TestLinkedListSingleArray(unittest.TestCase):
    ...
    def test_resize(self):
        ...
        self.assertListEqual(list_1._buffer, [None, 0, 4, None, 0, None])
        ...
        self.assertListEqual(
            list_1._buffer, [None, 0, 4, None, 0, 7, None, 0, 10, None, 0, None]
        )
    ...
    def test_push(self):
        ...
        self.assertListEqual(list_1._buffer, [None, 0, 4, None, 0, 7, None, 0, None])
        ...
        self.assertListEqual(
            list_1._buffer, [None, "A", None, None, 0, 7, None, 0, None]
        )
        ...
        self.assertListEqual(
            list_1._buffer, [4, "A", None, None, "B", 1, None, 0, None]
        )
        self.assertEqual(len(list_1), 2)

        list_1.push("C")

        self.assertListEqual(list_1._buffer, [4, "A", None, 7, "B", 1, None, "C", 4])
    ...
    def test_initialise_from_list(self):
        ...
        self.assertListEqual(
            list_1._buffer, [4, "A", None, 7, "B", 1, 10, "C", 4, None, "D", 7]
        )
    ...
    def test_pop(self):
        ...
        self.assertListEqual(list_1._buffer, list_2._buffer)
    ...
    def test_reverse(self):
        ...
        self.assertEqual(
            list_1._buffer, [None, "A", 4, 1, "B", 7, 4, "C", 10, 7, "D", None]
        )
